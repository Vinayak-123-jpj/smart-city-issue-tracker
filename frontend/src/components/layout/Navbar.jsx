...
const Navbar = ({ user, onLogout }) => {
  ...
  const NavLink = ({ to, children, mobile = false, onClick }) => {
    ...
    const mobileClasses =
      "block px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg";
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            <div className="relative">
              ...
              >
                ...
                <svg
                  className={`w-4 h-4 text-gray-500 dark:text-gray-400 transition-transform duration-200 ${showProfileMenu ? "rotate-180" : ""}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        {showMobileMenu && (
          <div className="md:hidden py-4 border-t border-gray-200 dark:border-gray-700 animate-slide-down">
            <div className="space-y-1">
              {isCitizen && (
                <>
                  <NavLink to="/citizen/dashboard" mobile>
                    Dashboard
                  </NavLink>
                  <NavLink to="/citizen/map" mobile>
                    Map View
                  </NavLink>{" "}
                  {/* ADD THIS */}
                  <NavLink to="/citizen/my-issues" mobile>
                    My Issues
                  </NavLink>
                </>
              )}
              ...
              {isAuthority && (
                <>
                  <NavLink to="/authority/dashboard" mobile>
                    Dashboard
                  </NavLink>
                  <NavLink to="/authority/map" mobile>
                    Map View
                  </NavLink>{" "}
                  {/* ADD THIS */}
                  <NavLink to="/authority/analytics" mobile>
                    Analytics
                  </NavLink>
                </>
              )}
